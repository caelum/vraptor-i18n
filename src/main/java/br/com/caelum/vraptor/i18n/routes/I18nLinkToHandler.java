...
public class I18nLinkToHandler extends LinkToHandler {
	...
	@Inject
	public I18nLinkToHandler(ServletContext context, Router router, Proxifier proxifier,
			JstlLocalization localization) {
	...
	protected Linker linker(Class<?> controller, String methodName,
			List<Object> params) {
		return new I18nLinker(context, router, controller, methodName, params, localization);
	}
